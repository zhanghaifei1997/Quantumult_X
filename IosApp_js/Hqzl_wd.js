...
const body =
	`{"sessionId":"6554d2cd874d442b823f91ca59697038","appid":"wx30f3bf3802047cf6","userid":"b2c39600-6a7b-490d-8059-81ac6356ab9f","signdate":"2021-12-16"}`;
...
// console.log(`${new Date().getTime() + new Date().getTimezoneOffset() * 60 * 1000 + 8 * 60 * 60 * 1000}`)
// console.log(`${new Date()}`)
!(async () => {
	console.log('开始签到');
	let TodatTime = await GetToday();
	let Timestamp = await GetTimestamp();
	console.log("时间戳", Timestamp)
	console.log("今日日期", TodatTime)
